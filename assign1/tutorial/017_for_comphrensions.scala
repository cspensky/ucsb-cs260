...
// an important syntactic feature of Scala: for comprehensions.

// We have already talked in depth about operations on collections such
// as map, filter, flatMap, and so on.

// For comprehensions provide a convenient syntactic abstraction for these
// operations.
...
// When we postfix the for-comprehension with the keyword yield, it allows us to return
...
// This sounds oddly familiar right? If you remember the operation `map`,
// which takes a transforming function and applies it to each element, you
// may notice that these look startlingly similar.
